...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice and compete in interscholastic soccer matches",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim practice and technique improvement in the school pool",
    ...
    "Drama Club": {
        "description": "Rehearse and perform plays and theater pieces",
